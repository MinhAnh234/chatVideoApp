      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav me-auto">
            <jet-nav-link  class="dashboard" :href="route('dashboard')" :active="route().current('dashboard')">
              Dashboard
            </jet-nav-link>
             <jet-nav-link class="chatRoom" :href="route('chatRoom')" :active="route().current('chatRoom')">
              Chat Room
            </jet-nav-link>
            <jet-nav-link class="profile" :href="route('profile.show')">
                  Profile
            </jet-nav-link>
          </ul>
